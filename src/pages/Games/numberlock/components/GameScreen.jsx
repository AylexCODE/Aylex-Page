...
export default function GameScreen(props){
    ...
    return (
        <section ref={gameContainer} className="w-full h-fit flex flex-col items-center">
            ...
            <div ref={box} className="absolute top-[2px] left-[2px] size-[50px] border bg-[#FFD700] z-2"></div><span className="absolute top-[2px] left-[2px] size-[50px] border border-gray-500 border-dashed z-1" id="boxContainer"></span>
